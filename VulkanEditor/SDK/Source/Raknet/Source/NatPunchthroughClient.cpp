...
char *TestModeToString(NatPunchthroughClient::SendPing::TestMode tm)			//I, Colton Soneson, Have modified this function 
{
	switch (tm)
	{
		case NatPunchthroughClient::SendPing::TESTING_INTERNAL_IPS:
			return const_cast<char*>("TESTING_INTERNAL_IPS");
		break;
		case NatPunchthroughClient::SendPing::WAITING_FOR_INTERNAL_IPS_RESPONSE:
			return const_cast<char*>("WAITING_FOR_INTERNAL_IPS_RESPONSE");
		break;
...
// 		break;
		case NatPunchthroughClient::SendPing::TESTING_EXTERNAL_IPS_FACILITATOR_PORT_TO_FACILITATOR_PORT:
			return const_cast<char*>("TESTING_EXTERNAL_IPS_FACILITATOR_PORT_TO_FACILITATOR_PORT");
		break;
		case NatPunchthroughClient::SendPing::TESTING_EXTERNAL_IPS_1024_TO_FACILITATOR_PORT:
			return const_cast<char*>("TESTING_EXTERNAL_IPS_1024_TO_FACILITATOR_PORT");
		break;
		case NatPunchthroughClient::SendPing::TESTING_EXTERNAL_IPS_FACILITATOR_PORT_TO_1024:
			return const_cast<char*>("TESTING_EXTERNAL_IPS_FACILITATOR_PORT_TO_1024");
		break;
		case NatPunchthroughClient::SendPing::TESTING_EXTERNAL_IPS_1024_TO_1024:
			return const_cast<char*>("TESTING_EXTERNAL_IPS_1024_TO_1024");
		break;
		case NatPunchthroughClient::SendPing::WAITING_AFTER_ALL_ATTEMPTS:
			return const_cast<char*>("WAITING_AFTER_ALL_ATTEMPTS");
		break;
		case NatPunchthroughClient::SendPing::PUNCHING_FIXED_PORT:
			return const_cast<char*>("PUNCHING_FIXED_PORT");
		break;
	}
